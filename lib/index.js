...
CodeBite.prototype.buildEvents = function() {
  ...
  //   self.viewProps.status = 'done';
  //   self.viewProps.areResultsVisible = true;
  //   self.viewProps.results = result.filter(function(block) { return block[0]; });
  //   self.viewProps.lastRunTime = Date.now();
  //   self.view = preact.render(preact.h(CodeBiteView, self.viewProps), self.element, self.view);
  // });
  ...
  // this.connection.addEventListener('close', function disableRunButton() {
